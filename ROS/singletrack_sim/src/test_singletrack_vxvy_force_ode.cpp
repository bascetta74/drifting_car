...
int main() {
    ...
    singletrack_vxvy_force_ode sim = singletrack_vxvy_force_ode(dT, singletrack_vxvy_force_ode::LINEAR, singletrack_vxvy_force_ode::IDEAL);
//    singletrack_vxvy_force_ode sim = singletrack_vxvy_force_ode(dT, singletrack_vxvy_force_ode::LINEAR, singletrack_vxvy_force_ode::REAL);
//    singletrack_vxvy_force_ode sim = singletrack_vxvy_force_ode(dT, singletrack_vxvy_force_ode::FIALA_WITH_SATURATION, singletrack_vxvy_force_ode::IDEAL);
//    singletrack_vxvy_force_ode sim = singletrack_vxvy_force_ode(dT, singletrack_vxvy_force_ode::FIALA_WITH_SATURATION, singletrack_vxvy_force_ode::REAL);
//    singletrack_vxvy_force_ode sim = singletrack_vxvy_force_ode(dT, singletrack_vxvy_force_ode::FIALA_WITHOUT_SATURATION, singletrack_vxvy_force_ode::IDEAL);
//    singletrack_vxvy_force_ode sim = singletrack_vxvy_force_ode(dT, singletrack_vxvy_force_ode::FIALA_WITHOUT_SATURATION, singletrack_vxvy_force_ode::REAL);
    ...
    result_file.open ("test_singletrack_vxvy_force_results.txt");
