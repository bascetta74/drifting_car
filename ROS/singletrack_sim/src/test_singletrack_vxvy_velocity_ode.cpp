...
int main(int argc, char** argv) {
    ...
    if (argc<2) {
        ...
        std::cout << "test_singletrack_vxvy_velocity_ode tire_type actuation_type" << std::endl;
    ...
    singletrack_vxvy_velocity_ode* sim;
    if (!strcmp(argv[1], "linear") && !strcmp(argv[2], "ideal")) {
        sim = new singletrack_vxvy_velocity_ode(dT, singletrack_vxvy_velocity_ode::LINEAR, singletrack_vxvy_velocity_ode::IDEAL, 0.05);
        std::cout << "Running singletrack_vxvy_velocity_ode, linear tyre, ideal actuation" << std::endl;
    }
    else if (!strcmp(argv[1], "linear") && !strcmp(argv[2], "real")) {
        sim = new singletrack_vxvy_velocity_ode(dT, singletrack_vxvy_velocity_ode::LINEAR, singletrack_vxvy_velocity_ode::REAL, 0.05);
        std::cout << "Running singletrack_vxvy_velocity_ode, linear tyre, real actuation" << std::endl;
    }
    else if (!strcmp(argv[1], "fiala_w_sat") && !strcmp(argv[2], "ideal")) {
        sim = new singletrack_vxvy_velocity_ode(dT, singletrack_vxvy_velocity_ode::FIALA_WITH_SATURATION, singletrack_vxvy_velocity_ode::IDEAL, 0.05);
        std::cout << "Running singletrack_vxvy_velocity_ode, Fiala with saturation tyre, ideal actuation" << std::endl;
    }
    else if (!strcmp(argv[1], "fiala_w_sat") && !strcmp(argv[2], "real")) {
        sim = new singletrack_vxvy_velocity_ode(dT, singletrack_vxvy_velocity_ode::FIALA_WITH_SATURATION, singletrack_vxvy_velocity_ode::REAL, 0.05);
        std::cout << "Running singletrack_vxvy_velocity_ode, Fiala with saturation tyre, real actuation" << std::endl;
    }
    else if (!strcmp(argv[1], "fiala_wo_sat") && !strcmp(argv[2], "ideal")) {
        sim = new singletrack_vxvy_velocity_ode(dT, singletrack_vxvy_velocity_ode::FIALA_WITHOUT_SATURATION, singletrack_vxvy_velocity_ode::IDEAL, 0.05);
        std::cout << "Running singletrack_vxvy_velocity_ode, Fiala without saturation tyre, ideal actuation" << std::endl;
    }
    else if (!strcmp(argv[1], "fiala_wo_sat") && !strcmp(argv[2], "real")) {
        sim = new singletrack_vxvy_velocity_ode(dT, singletrack_vxvy_velocity_ode::FIALA_WITHOUT_SATURATION, singletrack_vxvy_velocity_ode::REAL, 0.05);
        std::cout << "Running singletrack_vxvy_velocity_ode, Fiala without saturation tyre, real actuation" << std::endl;
    }
    else {
    ...
    sim->setActuatorParams(mu_steer, wn_steer, csi_steer, tau_steer, mu_speed, wn_speed, csi_speed, tau_speed);
    ...
    result_file_name = "test_singletrack_vxvy_velocity_" + std::string(argv[1]) + "_" + std::string(argv[2]) + ".txt";
