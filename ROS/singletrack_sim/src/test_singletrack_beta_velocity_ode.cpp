...
int main(int argc, char** argv) {
    ...
    if (!strcmp(argv[1], "linear") && !strcmp(argv[2], "ideal")) {
        sim = new singletrack_beta_velocity_ode(dT, singletrack_beta_velocity_ode::LINEAR, singletrack_beta_velocity_ode::IDEAL, 0.05);
        ...
        sim = new singletrack_beta_velocity_ode(dT, singletrack_beta_velocity_ode::LINEAR, singletrack_beta_velocity_ode::REAL, 0.05);
        ...
        sim = new singletrack_beta_velocity_ode(dT, singletrack_beta_velocity_ode::FIALA_WITH_SATURATION, singletrack_beta_velocity_ode::IDEAL, 0.05);
        ...
        sim = new singletrack_beta_velocity_ode(dT, singletrack_beta_velocity_ode::FIALA_WITH_SATURATION, singletrack_beta_velocity_ode::REAL, 0.05);
        ...
        sim = new singletrack_beta_velocity_ode(dT, singletrack_beta_velocity_ode::FIALA_WITHOUT_SATURATION, singletrack_beta_velocity_ode::IDEAL, 0.05);
        ...
        sim = new singletrack_beta_velocity_ode(dT, singletrack_beta_velocity_ode::FIALA_WITHOUT_SATURATION, singletrack_beta_velocity_ode::REAL, 0.05);
