...
int main() {
    ...
    singletrack_beta_velocity_ode sim = singletrack_beta_velocity_ode(dT, singletrack_beta_velocity_ode::LINEAR, singletrack_beta_velocity_ode::IDEAL);
//    singletrack_beta_velocity_ode sim = singletrack_beta_velocity_ode(dT, singletrack_beta_velocity_ode::LINEAR, singletrack_beta_velocity_ode::REAL);
//    singletrack_beta_velocity_ode sim = singletrack_beta_velocity_ode(dT, singletrack_beta_velocity_ode::FIALA_WITH_SATURATION, singletrack_beta_velocity_ode::IDEAL);
//    singletrack_beta_velocity_ode sim = singletrack_beta_velocity_ode(dT, singletrack_beta_velocity_ode::FIALA_WITH_SATURATION, singletrack_beta_velocity_ode::REAL);
//    singletrack_beta_velocity_ode sim = singletrack_beta_velocity_ode(dT, singletrack_beta_velocity_ode::FIALA_WITHOUT_SATURATION, singletrack_beta_velocity_ode::IDEAL);
//    singletrack_beta_velocity_ode sim = singletrack_beta_velocity_ode(dT, singletrack_beta_velocity_ode::FIALA_WITHOUT_SATURATION, singletrack_beta_velocity_ode::REAL);
    ...
    result_file.open ("test_singletrack_beta_velocity_results.txt");
