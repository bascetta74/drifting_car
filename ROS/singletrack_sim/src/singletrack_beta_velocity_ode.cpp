...
singletrack_beta_velocity_ode::singletrack_beta_velocity_ode(double deltaT, tyreModel tyre_model, actuatorModel actuator_model) : dt(deltaT),
...
{
    // state = [ r, beta, x, y, psi, steer_pos, steer_vel ]
...
void singletrack_beta_velocity_ode::setSteeringActuatorParams(double gain, double frequency, double damping, int delay)
{
...
void singletrack_beta_velocity_ode::setVelocityActuatorParams(double gain)
{
...
void singletrack_beta_velocity_ode::integrate()
{
    ...
    if ((!steeringActuatorParams_set) && (steeringActuator_model!=singletrack_beta_velocity_ode::IDEAL)) {
