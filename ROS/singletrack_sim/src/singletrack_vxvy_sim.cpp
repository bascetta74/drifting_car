...
void singletrack_sim::Prepare(void)
{
 ...
 /* ROS topics */
 vehicleCommand_subscriber = Handle.subscribe("/controller_cmd", 1, &singletrack_sim::vehicleCommand_MessageCallback, this);
...
void singletrack_sim::vehicleCommand_MessageCallback(const car_msgs::car_cmd::ConstPtr& msg)
{
