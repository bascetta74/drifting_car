    ...
    if (actuator_model == 0) {         // ideal
        if (tyre_model == 0) {         // linear
            if (input_cmd == 0) {      // velocity
                sim_velocity = new singletrack_vxvy_velocity_ode(dt, singletrack_vxvy_velocity_ode::LINEAR,
                ...
                sim_force = new singletrack_vxvy_force_ode(dt, singletrack_vxvy_force_ode::LINEAR,
            ...
            if (input_cmd == 0) {      // velocity
                sim_velocity = new singletrack_vxvy_velocity_ode(dt,
                ...
                sim_force = new singletrack_vxvy_force_ode(dt, singletrack_vxvy_force_ode::FIALA_WITH_SATURATION,
                                                           singletrack_vxvy_force_ode::IDEAL, 0.05);
            ...
            if (input_cmd == 0) {      // velocity
                ...
                sim_force = new singletrack_vxvy_force_ode(dt, singletrack_vxvy_force_ode::FIALA_WITHOUT_SATURATION,
                                                           singletrack_vxvy_force_ode::IDEAL, 0.05);
