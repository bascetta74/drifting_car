...
int main(int argc, char** argv) {
    ...
    if (argc<2) {
        ...
        std::cout << "test_singletrack_beta_force_ode tire_type actuation_type" << std::endl;
    ...
    singletrack_beta_force_ode* sim;
    if (!strcmp(argv[1], "linear") && !strcmp(argv[2], "ideal")) {
        sim = new singletrack_beta_force_ode(dT, singletrack_beta_force_ode::LINEAR, singletrack_beta_force_ode::IDEAL, 0.01);
        std::cout << "Running singletrack_beta_force_ode, linear tyre, ideal actuation" << std::endl;
    }
    else if (!strcmp(argv[1], "linear") && !strcmp(argv[2], "real")) {
        sim = new singletrack_beta_force_ode(dT, singletrack_beta_force_ode::LINEAR, singletrack_beta_force_ode::REAL, 0.01);
        std::cout << "Running singletrack_beta_force_ode, linear tyre, real actuation" << std::endl;
    }
    else if (!strcmp(argv[1], "fiala_w_sat") && !strcmp(argv[2], "ideal")) {
        sim = new singletrack_beta_force_ode(dT, singletrack_beta_force_ode::FIALA_WITH_SATURATION, singletrack_beta_force_ode::IDEAL, 0.01);
        std::cout << "Running singletrack_beta_force_ode, Fiala with saturation tyre, ideal actuation" << std::endl;
    }
    else if (!strcmp(argv[1], "fiala_w_sat") && !strcmp(argv[2], "real")) {
        sim = new singletrack_beta_force_ode(dT, singletrack_beta_force_ode::FIALA_WITH_SATURATION, singletrack_beta_force_ode::REAL, 0.01);
        std::cout << "Running singletrack_beta_force_ode, Fiala with saturation tyre, real actuation" << std::endl;
    }
    else if (!strcmp(argv[1], "fiala_wo_sat") && !strcmp(argv[2], "ideal")) {
        sim = new singletrack_beta_force_ode(dT, singletrack_beta_force_ode::FIALA_WITHOUT_SATURATION, singletrack_beta_force_ode::IDEAL, 0.01);
        std::cout << "Running singletrack_beta_force_ode, Fiala without saturation tyre, ideal actuation" << std::endl;
    }
    else if (!strcmp(argv[1], "fiala_wo_sat") && !strcmp(argv[2], "real")) {
        sim = new singletrack_beta_force_ode(dT, singletrack_beta_force_ode::FIALA_WITHOUT_SATURATION, singletrack_beta_force_ode::REAL, 0.01);
        std::cout << "Running singletrack_beta_force_ode, Fiala without saturation tyre, real actuation" << std::endl;
    }
    else {
    ...
    result_file_name = "test_singletrack_beta_force_" + std::string(argv[1]) + "_" + std::string(argv[2]) + ".txt";
