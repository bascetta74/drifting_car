...
% Run cpp simulation
system('../test/test_singletrack_vxvy_force_ode linear real');

% Load cpp simulation results
res = load('test_singletrack_vxvy_force_linear_real.txt');
ode_res.t         = res(:,1);
...
delete('test_singletrack_vxvy_force_linear_real.txt');
