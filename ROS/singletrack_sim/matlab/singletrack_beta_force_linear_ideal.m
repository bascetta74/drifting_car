...
% Run cpp simulation
system('../test/test_singletrack_beta_force_ode linear ideal');

% Load cpp simulation results
res = load('test_singletrack_beta_force_linear_ideal.txt');
ode_res.t         = res(:,1);
...
delete('test_singletrack_beta_force_linear_ideal.txt');
