...
% Run cpp simulation
system('../test/test_singletrack_beta_velocity_ode fiala_wo_sat real');

% Load cpp simulation results
res = load('test_singletrack_beta_velocity_fiala_wo_sat_real.txt');
ode_res.t         = res(:,1);
...
delete('test_singletrack_beta_velocity_fiala_wo_sat_real.txt');
