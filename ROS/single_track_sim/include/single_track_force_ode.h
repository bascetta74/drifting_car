...
public:
    ...
    single_track_force_ode(double deltaT, tyreModel tyre_model, actuatorModel actuator_model);
    ...
    void getLongitudinalDynamics(double &vx) { vx = state[2]; };
