...
int main() {
    ...
    single_track_force_ode sim = single_track_force_ode(dT, single_track_force_ode::LINEAR, single_track_force_ode::IDEAL);
//    single_track_force_ode sim = single_track_force_ode(dT, single_track_force_ode::LINEAR, single_track_force_ode::REAL);
//    single_track_force_ode sim = single_track_force_ode(dT, single_track_force_ode::FIALA_WITH_SATURATION, single_track_force_ode::IDEAL);
//    single_track_force_ode sim = single_track_force_ode(dT, single_track_force_ode::FIALA_WITH_SATURATION, single_track_force_ode::REAL);
//    single_track_force_ode sim = single_track_force_ode(dT, single_track_force_ode::FIALA_WITHOUT_SATURATION, single_track_force_ode::IDEAL);
//    single_track_force_ode sim = single_track_force_ode(dT, single_track_force_ode::FIALA_WITHOUT_SATURATION, single_track_force_ode::REAL);
    ...
    result_file.open ("test_single_track_force_results.txt");
